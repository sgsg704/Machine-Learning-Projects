...
if __name__=="__main__":
    ls2013=avg_data_2013()
    ls2014=avg_data_2014()
    ls2015=avg_data_2015()
    ls2016=avg_data_2016()
    ls2017=avg_data_2017()
    ls2018=avg_data_2018()
    plt.plot(range(0,365),ls2013,label="2013 data")
    plt.plot(range(0,364),ls2014,label="2014 data")
    plt.plot(range(0,365),ls2015,label="2015 data")
